...
public class SendImageCommandHandlerProviderBean implements ServerChatClientCommandHandlerProviderBean {
    ...
    public Collection<String> getHandledCommands() {
        return Arrays.asList("SEND-IMAGE");
    }
    ...
    public CommandHandler<ServerChatClientMessageHandlingContext> getCommandHandler() {
        return (context, request) -> {
            ...
            byte [] imageContent = Base64.getDecoder().decode(json.getString("imageContent"));
            ...
            message.setImageMessage(true);
            message.setFileId(fileId);
            message.setImageExtension(json.getString("extension"));
            ...
            FileUtils.writeByteArrayToFile(uploadFile, imageContent);
